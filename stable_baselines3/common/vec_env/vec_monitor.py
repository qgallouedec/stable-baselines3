...
class VecMonitor(VecEnvWrapper):
    ...
    def __init__(
        ...
        self.inner_episode_returns = None
    ...
    def reset(self) -> VecEnvObs:
        ...
        self.inner_episode_returns = np.zeros(self.num_envs, dtype=np.float32)
    ...
    def step_wait(self) -> VecEnvStepReturn:
        ...
        self.inner_episode_returns += infos.get("env_reward", 0)
        ...
        for i in range(len(dones)):
            if dones[i]:
                ...
                inner_episode_return = self.inner_episode_returns[i]
                episode_length = self.episode_lengths[i]
                episode_info = {
                    "r": episode_return,
                    "i": inner_episode_return,
                    "l": episode_length,
                ...
                self.inner_episode_returns[i] = 0
